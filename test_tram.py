...
# ]
list_direname = [
    f"""H:\Tcl\{str(100)} Xref Ligne D""",
    f"""H:\Tcl\{str(100)} Xref Parc relais Mermoz""",
    f"""H:\Tcl\{str(100)} Xref Pôle vénissieux""",
    f"""H:\Tcl\{str(100)} Xref PRV2""",
    f"""H:\Tcl\{str(300)} - Métro D - communs""",
    f"""H:\Tcl\{str(301)} - Métro D - interstations""",
    f"""H:\Tcl\{str(303)} - Liaison BD""",
    f"""H:\Tcl\{str(305)} à 322 - Métro D - stations""",
]
