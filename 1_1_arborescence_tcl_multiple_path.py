...
# dirname = [
#     f"""F:\Tcl\{str(105)} à {str(122)} - Métro A - stations\Cordeliers""",
#     f"""F:\Tcl\{str(105)} à {str(122)} - Métro A - stations\Hotel de Ville A et C""",
#     f"""F:\Tcl\{str(105)} à {str(122)} - Métro A - stations\Foch""",
                ...
                for ref_fourn, ref_fiche in zip(
                    ...
                    if (
                        ...
                        if value[:2] == "AQ":
                            ...
                            #     )
                            if (
                                value_last_eight[:2] == "TS"
                                or value_last_eight[:2] == "TP"
                            ):
                                if (
                                    value_last_eight.replace(
                                        value_last_eight[1], value_last_eight[1] + " "
                    ...
                    for dash in list_need_dash:
                        if dash in value and re.match("\w{2}.?\d{5,}", value):
                            ...
                            value_dash_remove_space = value.replace(
                                dash + " ", dash + "-"
                            )
                            ...
                            if re.match("(ST\d{6})", value):
                                ...
                                value_remove_post = value_remove_post[0]
                                value_remove_post = value_remove_post.replace(
                                    "ST", "ST-"
                                )
                                if value_remove_post in ref_fourn:
                                    flag = True
